...
public class TechRadarNewsFinder extends NewsFinder {
    public TechRadarNewsFinder() {
        super();
        this.baseURl="https://www.techradar.com/news";
        this.publicationName="Tech Radar";
        this.logoID= R.drawable.tech_radar_logo;
